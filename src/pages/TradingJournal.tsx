  ...
  const journalEntries = [
    {
      ...
      content:
        "Today I entered a long position on BTC at $42,500. The technical analysis showed strong support at this level with RSI oversold. My stop loss is set at $41,800 and target at $45,000. Market sentiment seems to be shifting positive after the recent consolidation period.",
    ...
    },
    {
      ...
      content:
        "Closed my ETH position at $2,480 for a small profit. Looking back, I should have held longer as it reached $2,580. Need to work on my patience and let winning trades run. The FOMO got to me when I saw some negative news, but it turned out to be FUD.",
    ...
    },
    {
      ...
      content:
        "Perfect scalp trade on SOL today. Entered at $98.20 and exited at $99.80 within 2 hours. The 1.6% gain was executed well, but I realize I need to increase my position size on high-confidence setups like this one.",
    ...
    },
    {
      ...
      content:
        "Today was a great example of why risk management is crucial. I had a strong conviction about a trade setup, but when it went against me, I stuck to my predetermined stop loss and exited for a small loss instead of hoping it would turn around. This saved me from what could have been a much larger loss as the market continued to move against the position.",
                        ...
                        <div className="h-full">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-2">
                              <Badge
                                variant={
                                  selectedEntry.outcome === "Profitable"
                                    ? "default"
                        ...
                        <div className="h-full min-h-[400px] bg-background/50 rounded-lg border border-border/50 flex items-center justify-center">
                          <div className="text-center">
                            ...
                            <p className="text-muted-foreground">
                              Select an entry to view or start writing a new one
                            </p>
                          </div>
                        </div>
                      )}
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge
                              variant={
                                entry.outcome === "Profitable"
                                  ? "default"
                                  : entry.outcome === "Missed Opportunity"
                                  ? "secondary"
                                  : "destructive"
                              }
                              className="text-xs"
